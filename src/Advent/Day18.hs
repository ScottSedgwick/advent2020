...
expr1 :: Parser Node
expr1 = makeExprParser (parens expr1 <|> (Val <$> integer) <?> "term") [ [ InfixL (Pro <$ symbol "*"), InfixL (Sum <$ symbol "+") ] ]

expr2 :: Parser Node
expr2 = makeExprParser (parens expr2 <|> (Val <$> integer) <?> "term") [ [ InfixL (Sum <$ symbol "+") ], [ InfixL (Pro <$ symbol "*") ] ]
