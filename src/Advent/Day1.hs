...
day1pt2 :: [Int] -> Int
day1pt2 = safeCheck triples untriple 

triples :: [Int] -> [(Int, Int, Int)]
triples xs = f xs (pairs xs)
  where
    f (y:ys) zs = zip' (repeat y) zs ++ f ys zs
    f _ _ = []
    zip' (b:bs) ((c,d):cs) = (b,c,d):zip' bs cs
    zip' _ _ = []
